        ...
        <section>
            <div class="contendenor3">
                <div class="lista">
                    <nav class="nav-or">
                        <ul class="men-ul">
                            <li class="lis"><a class="munus" href="index.php?action=pag-productores">Perfil
                                    productor</a></li>
                            <li class="lis"><a class="munus" href="index.php?action=pag-transportadores">Perfil
                                    transportador</a></li>
                            <li class="lis"><a class="munus" href="index.php?action=pag-comerciantes">Perfil
                                    comercinate</a></li>
                            <li class="lis"><a class="munus" href="index.php?action=ver-productos"> ver productos</a>
                            </li>
                            <li class="lis"><a class="munus" href="index.php?action=ventas">ventas</a></li>
                            <li class="lis"><a class="munus" href="index.php?action=comprar-productos">comprar
                                    productos</a></li>
                            ...
                            <li class="lis"><a class="munus" href="index.php?action=contraseña">contraseña</a></li>
                        </ul>
                    </nav>
